...
const WeaponsRifled = (props) => {
  ...
  return (
    <div className={`${s.main} article_main`}>
      <Helmet>
        <title>Нарізна зброя - Gid Guns</title>
        <meta
          name="description"
          content="Історія нарізної зброї починається ще у 15 столітті, коли в Італії було винайдено першу ручну аркебузу. З тих пір вона постійно удосконалювалося та модернізувалося, а в кінці 19 століття стала основним видом вогнепальної зброї, що використовується в арміях всього світу."
        />
         <meta property="og:title" content="Нарізна зброя - Gid Guns" />
        <meta property="og:description" content="Історія нарізної зброї починається ще у 15 столітті, коли в Італії було винайдено першу ручну аркебузу. З тих пір вона постійно удосконалювалося та модернізувалося, а в кінці 19 століття стала основним видом вогнепальної зброї, що використовується в арміях всього світу." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="http://gidguns.info/wiki/rifled-weapons" />
        <meta property="og:image" content="http://gidguns.info/img/pages/rifled_weapons/rw1.jpg" />
      </Helmet>
      <div className={`${s.block} article_block`}>
        <figure className={`${s.img} article_img`} style={{ float: "left", width: 250 }}>
          <Image className={`${s.antImg} article_ant_img`}
      ...
      <div className={`${s.block} article_block`}>
        ...
        <div className={`${s.video} article_video`}>
          ...
          <h4><p className={`${s.headers} article_headers`}>{t("search.rifled-weapons.vdes1")}</p></h4>
        </div>
      </div>

      <div className={`${s.block} article_block`}>
        <h2><p className={`${s.headers} article_headers`}>
          {t("search.rifled-weapons.h1")}
        </p></h2>
        <p>{t("search.rifled-weapons.p6")}</p>
        <figure className={`${s.img} article_img`} style={{ float: "left", width: 75, margin: "5px 20px 0 20px" }}>
          <Image className={`${s.antImg} article_ant_img`}
            width={75}
      ...
      <div className={`${s.block} article_block`}>
        ...
        <div className={`${s.block} article_block`}>
          <figure className={`${s.groupImg} article_groupImg`} style={{ float: "left" }}>
            <div>
              <Image.PreviewGroup className={`${s.antImg} article_ant_img`}>
                <Image
                  width={65}
            ...
            <figcaption className={`${s.img_des} article_img_des`}><h4>{t("search.rifled-weapons.ides3")}</h4></figcaption>
        ...
        <div className={`${s.block} article_block`}>
          <figure className={`${s.groupImg} article_groupImg`} style={{ float: "right" }}>
            <div>
              <Image.PreviewGroup className={`${s.antImg} article_ant_img`}>
                <Image
                  width={65}
            ...
            <figcaption className={`${s.img_des} article_img_des`}><h4>{t("search.rifled-weapons.ides4")}</h4></figcaption>
          </figure>
      ...
      <div className={`${s.block} article_block`}>
        ...
        <figure className={`${s.img} article_img`} style={{ float: "left", width: 250 }}>
          ...
          />
          <figcaption className={`${s.img_des} article_img_des`}><h4>{t("search.rifled-weapons.ides5")}</h4></figcaption>
        </figure>
        <p>{toStrong(t("search.rifled-weapons.p17"), 1)}</p>
        <p>{t("search.rifled-weapons.p18")}</p>
        <p>{t("search.rifled-weapons.p19")}</p>
        <h2><p className={`${s.headers} article_headers`}>{t("search.rifled-weapons.p20")}</p></h2>
        <p>{t("search.rifled-weapons.p21")}</p>
        <p>{t("search.rifled-weapons.p22")}</p>
        <p>{toStrong(t("search.rifled-weapons.p23"), 1)}</p>

        <h2><p className={`${s.headers} article_headers`}>{t("search.rifled-weapons.p28")}</p></h2>
        ...
        <h2><p className={`${s.headers} article_headers`}>{t("search.rifled-weapons.p38")}</p></h2>
        ...
        <div className={`${s.video} article_video`}>
          ...
          <h4><p className={`${s.headers} article_headers`}>{t("search.rifled-weapons.vdes2")}</p></h4>
        </div>
      </div>
      <div className={`${s.block} article_block`}>
        <h2> <p className={`${s.headers} article_headers`}>{t("search.rifled-weapons.h4")}</p></h2>
        <p>{t("search.rifled-weapons.p41")}</p>
        <figure className={`${s.img} article_img`} style={{ float: "left", width: 350 }}>
          <Image className={`${s.antImg} article_ant_img`}

            src="/img/pages/rifled_weapons/rw11.jpg"
            alt={t("search.rifled-weapons.ides6")}
          />
          <figcaption className={`${s.img_des} article_img_des`}><h4>{t("search.rifled-weapons.ides6")}</h4></figcaption>
        </figure>
      ...
      <div className={`${s.block} article_block`}>
        <h2><p className={`${s.headers} article_headers`}>{t("search.rifled-weapons.p44")}</p></h2>
        ...
        <div className={`${s.video} article_video`}>
          ...
          <h4><p className={`${s.headers} article_headers`}>{t("search.rifled-weapons.vdes3")}</p></h4>
        </div>
        <p></p>
        ...
        <figure className={`${s.img} article_img`}  style={{ float: "right", width: 250 }}>
          ...
          />
          <figcaption className={`${s.img_des} article_img_des`}><h4>{t("search.rifled-weapons.ides7")}</h4></figcaption>
        </figure>
        ...
        <div className={`${s.video} article_video`}>
          ...
          <h4><p className={`${s.headers} article_headers`}>{t("search.rifled-weapons.vdes4")}</p></h4>
        </div>
        <p></p>
      </div>
      <div className={`${s.block} article_block`}>
        ...
        <figure className={`${s.img} article_img`} style={{ float: "left", width: 250 }}>
          ...
          />
          <figcaption className={`${s.img_des} article_img_des`}><h4>{t("search.rifled-weapons.ides8")}</h4></figcaption>
        </figure>
        ...
        <div className={`${s.video} article_video`}>
          ...
          <h4><p className={`${s.headers} article_headers`}>{t("search.rifled-weapons.vdes5")}</p></h4>
        </div>
      </div>
    </div>
  );
